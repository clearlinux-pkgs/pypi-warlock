...
Source0  : https://files.pythonhosted.org/packages/29/c2/3ba4daeddd47f1cfdbc703048cbee27bcbc50535261a2bbe36412565f3c9/warlock-2.1.0.tar.gz
...
%prep
%setup -q -n warlock-2.1.0
cd %{_builddir}/warlock-2.1.0
pushd ..
cp -a warlock-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748885121
